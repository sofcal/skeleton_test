 ...
 *     summary: Notifications POST
 *     description: |-
 *        handles notifications from Provider API
 *     tags:
 *       - Notification
 *     requestBody:
 *       description: |
 ...
 *         uri:
 *           Fn::Sub:
 *             arn:aws:apigateway:${AWS::Region}:lambda:path/2015-03-31/functions/${LambdaArnPrefix}-ApiNotifications/invocations
 *         responses:
 *           default:
 *             statusCode: "200"
