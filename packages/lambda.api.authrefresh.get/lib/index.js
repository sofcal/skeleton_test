 ...
 *     summary: AuthRefresh GET
 *     description: |-
 *        handles authrefresh from Provider API
 *     tags:
 *       - AuthRefresh
 *     parameters:
 *       - in: query
 ...
 *         uri:
 *           Fn::Sub:
 *             arn:aws:apigateway:${AWS::Region}:lambda:path/2015-03-31/functions/${LambdaArnPrefix}-ApiAuthRefresh/invocations
 *         responses:
 *           default:
 *             statusCode: "200"
